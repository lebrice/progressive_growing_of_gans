...
desc += '-BENCHMARK0'; sched.lod_initial_resolution = 128; train.total_kimg = 200; sched.tick_kimg_base = 1; sched.tick_kimg_dict = {}; train.image_snapshot_ticks = 10; train.network_snapshot_ticks = 100
